...
export default function HeroCanvas() {
  return (
    ...
    >
      ...
      <pointLight position={[-5, -3, 2]} intensity={20} color="#22d3ee" />
      ...
      <Environment resolution={256} frames={1}>
        <Lightformer form="circle" intensity={3} position={[3, 2, 2]} scale={4} color="#a855f7" />
        <Lightformer form="circle" intensity={3} position={[-4, -1, 2]} scale={4} color="#22d3ee" />
        <Lightformer form="ring" intensity={2} position={[0, 3, -3]} scale={5} color="#e879f9" />
        <Lightformer form="rect" intensity={1.5} position={[0, -4, 1]} scale={[8, 3, 1]} color="#7c3aed" />
      </Environment>
    </Canvas>
  )
}
