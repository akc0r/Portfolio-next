...
export function AboutSection({ copy }: AboutSectionProps) {
  return (
    <section
      ...
      className="surface-panel grid gap-10 rounded-[2.2rem] p-8 transition-colors sm:p-10"
    >
      <div className="space-y-4">
        <p className="text-xs uppercase tracking-[0.3em] text-orange-500 dark:text-orange-300">{copy.eyebrow}</p>
        <h3 id="about-heading" className="text-heading-theme text-3xl font-semibold leading-tight">
          {copy.title}
        </h3>
        <p className="text-muted-theme text-base leading-relaxed">
          {copy.paragraphOne}
        </p>
        <p className="text-muted-theme text-base leading-relaxed">
          {copy.paragraphTwo}
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="surface-card rounded-2xl p-5 transition-all duration-300 hover:-translate-y-0.5">
        ...
        <div className="surface-card rounded-2xl p-5 transition-all duration-300 hover:-translate-y-0.5 lg:col-span-1">
