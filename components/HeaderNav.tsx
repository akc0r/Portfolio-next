  ...
  return (
    <header className="sticky top-4 z-40 space-y-6">
      <div className="surface-panel rounded-[2.2rem] p-5 transition-colors sm:p-7">
        <div className="flex items-start justify-between gap-4 border-b border-slate-200/70 pb-4 dark:border-slate-700/70">
        ...
        <div className="mt-4 flex items-center">
          <span className="rounded-full border border-teal-400/45 bg-teal-400/12 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.25em] text-teal-700 dark:border-teal-300/40 dark:bg-teal-300/12 dark:text-teal-200">
            {copy.availability}
          </span>
        </div>
